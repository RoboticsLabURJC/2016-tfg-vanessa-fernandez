...
if __name__ == "__main__":
    ...
    cameraL = CameraClient(ic, "Overtaking.CameraLeft", True)
    cameraR = CameraClient(ic, "Overtaking.CameraRight", True)
    motors = Motors (ic, "Overtaking.Motors")
    pose3d = Pose3DClient(ic, "Overtaking.Pose3D", True)
    laser = LaserClient(ic, "Overtaking.Laser", True)
