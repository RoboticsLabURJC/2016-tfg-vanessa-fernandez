...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def openEnvironment(self):
        ...
        fname = "/home/vanejessi/Descargas/omplapp-1.2.1-Source/resources/2D/Maze_planar_env.dae"
    ...
    def openRobot(self):
        ...
        fname = "/home/vanejessi/Descargas/omplapp-1.2.1-Source/resources/2D/car1_planar_robot.dae"
...
class Pose3DBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, title):
        ...
        layout.addWidget(posxLabel, 1, 1)
        layout.addWidget(posyLabel, 2, 1)
        layout.addWidget(poszLabel, 3, 1)
        layout.addWidget(rotxLabel, 1, 2)
        layout.addWidget(rotyLabel, 2, 2)
        layout.addWidget(rotzLabel, 3, 2)
        self.setLayout(layout)
...
class Pose2DBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, title):
        ...
        self.rot = 0.00
        rotLabel = QtWidgets.QLabel("          " + str(self.rot))
        ...
        layout.addWidget(posxLabel, 0, 1)
        layout.addWidget(posyLabel, 1, 1)
        layout.addWidget(rotLabel, 2, 1)
        self.setLayout(layout)
